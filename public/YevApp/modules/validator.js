...
angular.module('validator').directive('validator',
    function() {
        return {
            restrict: 'A',
            link: function(scope, element, attrs, fn) {
                ...
                element.on('submit', function(event) {
                    ...
                    // If the form is valid then call the function that is declared in the validator-submit atrribute on the form element
                    if (scopeForm.$valid) {
                        scope.$apply(function() {
                            scope.$eval(DOMForm.attributes["validator-submit"].value);
                        });
                    }
                });
                ...
                function checkElementValididty(element) {
                    ...
                    if ("validator" in element.attributes) {
                        ...
                        scopeForm[element.name].$setValidity("validator", isElementValid);
